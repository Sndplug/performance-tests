...
class SeedAccountsPlan(BaseModel):
    ...
    Attributes:
        ...
        transfer_operations (SeedOperationsPlan): План по созданию операции перевода средств.
        cash_withdrawal_operations (SeedOperationsPlan): План по созданию снятия наличных.
    """
    count: int = 0
