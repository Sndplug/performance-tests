...
class SeedAccountResult(BaseModel):
    ...
    Attributes:
        ...
        transfer_operations (list[SeedOperationResult]): Список перевода средств
        cash_withdrawal_operations (list[SeedOperationResult]): Список снятия наличных средств.
    """
    account_id: str
